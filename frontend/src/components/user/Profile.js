...
const {user} = useSelector(state =>state.authState);
    ...
    return(
        ...
        <div className="col-12 col-md-3">
            <figure className='avatar avatar-profile'>
                ...
                {/* {user.avatar??'./images/default_avatar.png' - idhu vandhu irundha kaami ilati default image kaami nu slradhukaga} */}
            </figure>
  ...
  {/* {String(user.createdAt).substring(0, 10)}-  string ah convert panni 0 t0 10 iruka letters ah substring pottu edukrom to show date */}
